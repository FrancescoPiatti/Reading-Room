...
You are building one entry in a personal "Reading Room" — a catalogue of focused paper breakdowns. Work **interactively** and stop at the approval gate below. Do **not** use the Anthropic API or `claude -p`; this runs inside the current interactive session.

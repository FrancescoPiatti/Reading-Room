---
name: setup
description: "Set up (or update) your Reading Room profile and field config so reports are tailored to your discipline. Replaces /profile. Invoke only when the user explicitly selects $setup or /setup."
---

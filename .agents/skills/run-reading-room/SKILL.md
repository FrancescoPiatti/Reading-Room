...
```bash
node .agents/skills/run-reading-room/driver.mjs serve            # start headless; prints http://127.0.0.1:<port>/
node .agents/skills/run-reading-room/driver.mjs smoke            # 5 health+security checks (exit 0 = all pass)
